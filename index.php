...
<head>
   ...
   <title>Putri Narila - Stok Barang</title>
      ...
      <div id="layoutSidenav_content">
         <main>
            <div class="container-fluid px-4">
               <h1 class="mt-4 heading">Sistem Stok Barang</h1>
               <div class="card mb-4">
                  <div class="card-header">
                     ...
                     <a href="export.php" class="btn btn-secondary" target="_blank">Export Data</a>
                  </div>
                  <div class="card-body">
                     <?php
                        $ambildatastok = mysqli_query($conn, "SELECT * FROM stock WHERE stock<1");
                        while($array = mysqli_fetch_array($ambildatastok)){
                           $barang = $array['namabarang'];
                     ?>

                     <div class="alert alert-danger alert-dismissible fade show" role="alert">
                        Stok <strong><?=$barang;?></strong> HABIS !!
                     ...
                     <table id="datatablesSimple" class="table table-bordered">
                        ...
                        <tbody>
                           ...
                           <tr>
                              ...
                              <td>
                                 <a href="detail.php?id=<?=$idb;?>"
                                    class="text-decoration-none text-success fs-5 fw-bolder"><?=$namabarang;?></a>
                              <td>
                                 <?=$deskripsi;?>
                              </td>
                              <td>
                           ...
                           <!-- Modal Edit Barang-->
                           <div class="modal fade" id="edit<?=$idb;?>" data-bs-backdrop="static"
                              ...
                              <div class="modal-dialog">
                                 <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                       <form method="post" enctype="multipart/form-data">
                                          <div class=" form-floating">
                                             <input type="text" name="namabarang" id="floatingInputGroup1"
                                                class="form-control mb-3" value="<?=$namabarang;?>" required>
                                             <label for="floatingInputGroup1" class="text-secondary">Nama Barang</label>
                                          </div>
                                          <div class=" form-floating">
                                             <input type="text" name="deskripsi" id="floatingInputGroup1"
                                    ...
                                    <div class="modal-footer">
                                       <button type="submit" class="btn btn-warning float-start" name="updatebarang"
                                          id="updatebarang">Simpan</button>
                           ...
                           <!-- Modal Delete Barang-->
                           <div class="modal fade" id="delete<?=$idb;?>" data-bs-backdrop="static"
                              data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel"
                              aria-hidden="true">
                              <div class="modal-dialog">
                                 <div class="modal-content">
                                    <div class="modal-header">
                                       <h1 class="modal-title fs-5 heading" id="staticBackdropLabel">Hapus Barang</h1>
                                       <button type="button" class="btn-close" data-bs-dismiss="modal"
                                          aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body">
                                    ...
                                    <div class="modal-footer">
                                       <button type="submit" class="btn btn-danger float-start" name="hapusbarang"
                                          id="hapusbarang">Hapus</button>
                                       <button type="button" class="btn btn-secondary float-end"
                                          data-bs-dismiss="modal">Batal</button>
                                    </div>
                                    </form>
...
<div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
   ...
   <div class="modal-dialog">
      <div class="modal-content">
         ...
         <div class="modal-footer">
            <button type="submit" class="btn btn-success" name="tambahbarangbaru" id="tambahbarangbaru">Simpan</button>
